<div class="docs-hero">
  <h1>BlockadeLabs</h1>
  <p class="docs-hero-lead">Modern .NET SDK for BlockadeLabs generated from the provider's OpenAPI definition with AutoSDK.</p>
  <div class="docs-badge-row">
    <a href="https://www.nuget.org/packages/BlockadeLabs/"><img alt="Nuget package" src="https://img.shields.io/nuget/vpre/BlockadeLabs"></a>
    <a href="https://github.com/tryAGI/BlockadeLabs/actions/workflows/dotnet.yml"><img alt="dotnet" src="https://github.com/tryAGI/BlockadeLabs/actions/workflows/dotnet.yml/badge.svg?branch=main"></a>
    <a href="https://github.com/tryAGI/BlockadeLabs/blob/main/LICENSE.txt"><img alt="License: MIT" src="https://img.shields.io/github/license/tryAGI/BlockadeLabs"></a>
...
<div class="docs-feature-grid">
  <div class="docs-feature-card">
    ...
    <p>Built from <a href="https://api-documentation.blockadelabs.com/blockade-labs-openapi.yaml">BlockadeLabs's OpenAPI definition</a> so the SDK stays close to the upstream API surface.</p>
  </div>
  <div class="docs-feature-card">
    <h3>Auto-updated</h3>
...
<div class="docs-card-grid">
  <div class="docs-card">
    <h3>Bugs</h3>
    <p>Open an issue in <a href="https://github.com/tryAGI/BlockadeLabs/issues">tryAGI/BlockadeLabs</a>.</p>
  </div>
  <div class="docs-card">
    <h3>Ideas and questions</h3>
    <p>Use <a href="https://github.com/tryAGI/BlockadeLabs/discussions">GitHub Discussions</a> for design questions and usage help.</p>
  </div>
  <div class="docs-card">
    <h3>Community</h3>
