...
namespace BlockadeLabs
{
    public partial class SkyboxExportsClient
    {
        ...
        private static readonly global::BlockadeLabs.EndPointSecurityRequirement s_GetExportRequestSecurityRequirement0 =
        ...
        private static readonly global::BlockadeLabs.EndPointSecurityRequirement[] s_GetExportRequestSecurityRequirements =
            new global::BlockadeLabs.EndPointSecurityRequirement[]
            {                s_GetExportRequestSecurityRequirement0,
            };
        partial void PrepareGetExportRequestArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareGetExportRequestRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessGetExportRequestResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetExportRequestResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::BlockadeLabs.GetExportRequestResponse> GetExportRequestAsync(
            string id,
            global::BlockadeLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetExportRequestAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::BlockadeLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::BlockadeLabs.AutoSDKHttpResponse<global::BlockadeLabs.GetExportRequestResponse>> GetExportRequestAsResponseAsync(
            string id,
            global::BlockadeLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetExportRequestArguments(
            ...
            var __authorizations = global::BlockadeLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetExportRequestSecurityRequirements,
                operationName: "GetExportRequestAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetExportRequestRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::BlockadeLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::BlockadeLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetExportRequestAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetExportRequestResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::BlockadeLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetExportRequestResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::BlockadeLabs.GetExportRequestResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::BlockadeLabs.AutoSDKHttpResponse<global::BlockadeLabs.GetExportRequestResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::BlockadeLabs.GetExportRequestResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
