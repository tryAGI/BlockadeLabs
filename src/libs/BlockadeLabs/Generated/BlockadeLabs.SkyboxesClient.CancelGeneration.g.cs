...
namespace BlockadeLabs
{
    public partial class SkyboxesClient
    {
        ...
        private static readonly global::BlockadeLabs.EndPointSecurityRequirement s_CancelGenerationSecurityRequirement0 =
        ...
        private static readonly global::BlockadeLabs.EndPointSecurityRequirement[] s_CancelGenerationSecurityRequirements =
            new global::BlockadeLabs.EndPointSecurityRequirement[]
            {                s_CancelGenerationSecurityRequirement0,
            };
        partial void PrepareCancelGenerationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareCancelGenerationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessCancelGenerationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCancelGenerationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::BlockadeLabs.CancelGenerationResponse> CancelGenerationAsync(
            string id,
            global::BlockadeLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CancelGenerationAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::BlockadeLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::BlockadeLabs.AutoSDKHttpResponse<global::BlockadeLabs.CancelGenerationResponse>> CancelGenerationAsResponseAsync(
            string id,
            global::BlockadeLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCancelGenerationArguments(
            ...
            var __authorizations = global::BlockadeLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CancelGenerationSecurityRequirements,
                operationName: "CancelGenerationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::BlockadeLabs.PathBuilder(
                                path: $"/api/v1/imagine/requests/{id}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCancelGenerationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::BlockadeLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::BlockadeLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CancelGenerationAsync",
                                pathTemplate: "$\"/api/v1/imagine/requests/{id}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCancelGenerationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::BlockadeLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCancelGenerationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::BlockadeLabs.CancelGenerationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::BlockadeLabs.AutoSDKHttpResponse<global::BlockadeLabs.CancelGenerationResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::BlockadeLabs.CancelGenerationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
