...
namespace BlockadeLabs
{
    public partial class SkyboxExportsClient
    {
        ...
        private static readonly global::BlockadeLabs.EndPointSecurityRequirement s_CancelExportRequestSecurityRequirement0 =
        ...
        private static readonly global::BlockadeLabs.EndPointSecurityRequirement[] s_CancelExportRequestSecurityRequirements =
            new global::BlockadeLabs.EndPointSecurityRequirement[]
            {                s_CancelExportRequestSecurityRequirement0,
            };
        partial void PrepareCancelExportRequestArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareCancelExportRequestRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessCancelExportRequestResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCancelExportRequestResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::BlockadeLabs.CancelExportRequestResponse> CancelExportRequestAsync(
            string id,
            global::BlockadeLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CancelExportRequestAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::BlockadeLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::BlockadeLabs.AutoSDKHttpResponse<global::BlockadeLabs.CancelExportRequestResponse>> CancelExportRequestAsResponseAsync(
            string id,
            global::BlockadeLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCancelExportRequestArguments(
            ...
            var __authorizations = global::BlockadeLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CancelExportRequestSecurityRequirements,
                operationName: "CancelExportRequestAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCancelExportRequestRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::BlockadeLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::BlockadeLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CancelExportRequestAsync",
                                pathTemplate: "$\"/api/v1/skybox/export/{id}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCancelExportRequestResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::BlockadeLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCancelExportRequestResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::BlockadeLabs.CancelExportRequestResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::BlockadeLabs.AutoSDKHttpResponse<global::BlockadeLabs.CancelExportRequestResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::BlockadeLabs.CancelExportRequestResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
