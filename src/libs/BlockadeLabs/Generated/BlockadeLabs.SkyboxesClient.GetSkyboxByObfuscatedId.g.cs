...
namespace BlockadeLabs
{
    public partial class SkyboxesClient
    {
        ...
        private static readonly global::BlockadeLabs.EndPointSecurityRequirement s_GetSkyboxByObfuscatedIdSecurityRequirement0 =
        ...
        private static readonly global::BlockadeLabs.EndPointSecurityRequirement[] s_GetSkyboxByObfuscatedIdSecurityRequirements =
            new global::BlockadeLabs.EndPointSecurityRequirement[]
            {                s_GetSkyboxByObfuscatedIdSecurityRequirement0,
            };
        partial void PrepareGetSkyboxByObfuscatedIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string obfuscatedId);
        partial void PrepareGetSkyboxByObfuscatedIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string obfuscatedId);
        partial void ProcessGetSkyboxByObfuscatedIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSkyboxByObfuscatedIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::BlockadeLabs.GetSkyboxByObfuscatedIdResponse> GetSkyboxByObfuscatedIdAsync(
            string obfuscatedId,
            global::BlockadeLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetSkyboxByObfuscatedIdAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::BlockadeLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::BlockadeLabs.AutoSDKHttpResponse<global::BlockadeLabs.GetSkyboxByObfuscatedIdResponse>> GetSkyboxByObfuscatedIdAsResponseAsync(
            string obfuscatedId,
            global::BlockadeLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSkyboxByObfuscatedIdArguments(
                httpClient: HttpClient,
                obfuscatedId: ref obfuscatedId);


            var __authorizations = global::BlockadeLabs.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetSkyboxByObfuscatedIdSecurityRequirements,
                operationName: "GetSkyboxByObfuscatedIdAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::BlockadeLabs.PathBuilder(
                                path: $"/api/v1/imagine/requests/obfuscated-id/{obfuscatedId}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::BlockadeLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::BlockadeLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetSkyboxByObfuscatedIdAsync",
                                pathTemplate: "$\"/api/v1/imagine/requests/obfuscated-id/{obfuscatedId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSkyboxByObfuscatedIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::BlockadeLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSkyboxByObfuscatedIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::BlockadeLabs.GetSkyboxByObfuscatedIdResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::BlockadeLabs.AutoSDKHttpResponse<global::BlockadeLabs.GetSkyboxByObfuscatedIdResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::BlockadeLabs.GetSkyboxByObfuscatedIdResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
