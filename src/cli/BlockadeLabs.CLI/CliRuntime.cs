...
namespace BlockadeLabs.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "BlockadeLabs.CLI";
    private const string UserSecretApiKeyName = "BLOCKADELABS_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"BLOCKADELABS_API_KEY"];
    private const string CredentialFileDirectoryName = ".blockade-labs";

    public static async global::System.Threading.Tasks.Task<global::BlockadeLabs.BlockadeLabsClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::BlockadeLabs.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::BlockadeLabs.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::BlockadeLabs.BlockadeLabsClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::BlockadeLabs.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::BlockadeLabs.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::BlockadeLabs.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::BlockadeLabs.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("BLOCKADELABS_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::BlockadeLabs.ApiException exception)
    {
        var builder = new StringBuilder();
