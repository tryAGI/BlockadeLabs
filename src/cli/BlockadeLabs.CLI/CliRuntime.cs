...
internal static class CliRuntime
{
    ...
    public static async Task<global::BlockadeLabs.BlockadeLabsClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::BlockadeLabs.ApiException exception)
    {
        var builder = new StringBuilder();
