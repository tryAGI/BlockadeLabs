...
The BlockadeLabs SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package BlockadeLabs
```
...
using var client = new BlockadeLabsClient(
    apiKey: Environment.GetEnvironmentVariable("BLOCKADELABS_API_KEY")!);
